# Login2eXploreProject-JsonPowerDB
...
This project is all about basics of JsonPowerDB (JPDB) and how to use JPDB for CRUD operations.Basically,it needs for us to be familiar us with JsonPowerDB.
